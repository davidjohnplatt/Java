...
public class InvoiceDetailMenu extends JFrame implements ActionListener{
...
*/   	
	...
	public InvoiceDetailMenu(String mCustID, String mInvoiceID) {
		super();
...
//		contentPane.add(panel);
	...
	private void loadInvoices () {
	   ...
	   invoiceChoice.add(".................");
 	   try {
 	   		String query = "SELECT invoice_id FROM invoice_master WHERE cust_id = "+ "'" + InvoiceID + "' ORDER BY invoice_date";
//			System.out.println(query);
    ...
    private void clearScreen() {
    	jTextCustomer.setText(InvoiceID);
    	jTextInvoiceID.setText(CustomerID);
...
/*	
	public static void main (String [] args) {
		InvoiceDetailMenu s = new InvoiceDetailMenu();
	}
