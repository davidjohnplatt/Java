...
public class JTableDisplayResults extends JFrame {
  ...
  public JTableDisplayResults(ResultSet res) {
  	 qTitle = "Query Result";
  	 makeTable(res);
  }
  
  public JTableDisplayResults(String pTitle,ResultSet res) {
  	 qTitle = pTitle;
  	 makeTable(res);
  }
  ...
  public void makeTable(ResultSet rs) {
    ...
    try {
      ...
      table.setModel(aModel);
         ...
         String errString = "Error connecting: " + sqle;
