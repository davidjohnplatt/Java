...
public class DriverUtilities {
  ...
  public static String makeURL(String host, String dbName, String portNumber,
                               int vendor) {
    if (vendor == ORACLE) {
      return("jdbc:oracle:thin:@" + host + ":" + portNumber + ":" + dbName);
    } else if (vendor == SYBASE) {
      return("jdbc:sybase:Tds:" + host  + ":1" + portNumber + "?SERVICENAME=" + dbName);
